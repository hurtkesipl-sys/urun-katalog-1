          ...
          <div className="flex items-center gap-2 md:gap-4 w-auto md:w-24 justify-end">
            {isTranslationEnabled && (
              <div className="flex items-center gap-1.5 mr-1 md:mr-2">
                ...
                <button onClick={() => changeLanguage('tr')} className="text-lg hover:scale-110 transition-transform" title="Türkçe">🇹🇷</button>
                <button onClick={() => changeLanguage('en')} className="text-lg hover:scale-110 transition-transform" title="English">🇬🇧</button>
                <button onClick={() => changeLanguage('ar')} className="text-lg hover:scale-110 transition-transform" title="العربية">🇸🇦</button>
                <button onClick={() => changeLanguage('ru')} className="text-lg hover:scale-110 transition-transform" title="Русский">🇷🇺</button>
              </div>
            )}
